    ...
    render() {
        return (
            ...
            <Modal show={this.state.showHide}>
                ...
                <Modal.Footer>
            <input type='submit' value='Cancelar' class='btn btn-primary'onClick={() => this.handleModalShowHide()}/>
                <input type="submit" value="Salvar" class="btn btn-primary" onClick={() => this.handleModalShowHide()}/>
                </Modal.Footer>
            </Modal>
            </>
        );
